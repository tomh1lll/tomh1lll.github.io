...
* [Hill and Unckless (2020A) Recurrent evolution of two competing haplotypes in an insect DNA virus.](files/TH_biorxivVirus_2020.05.14.pdf)
* [Hill and Unckless (2020B) Selection and demography shape genomic variation in a ‘Sky Island’ species.](files/TH_biorxivInnubila_2020.05.14.pdf)
...
<img src="files/Figure2.png" style="width:50%; margin-right: 20px" align="left">
...
* [Chapman, Hill and Unckless (2019) Balancing selection drives maintenance of genetic variation in *Drosophila* antimicrobial peptides.](files/TH_GBE_2019.pdf)
* [Hill & Unckless (2019) A simple deep-learning approach for detecting duplications and deletions in next-generation sequencing data.](files/TH_dudeML_2019.pdf)
* Hill & Unckless (In prep) Rampant duplication drives antimicrobial peptide diversity across the *Drosophila* phylogeny.

## Speciation and genome evolution in the *Drosophila dunni* subgroup

<img src="files/dunni_surv_website.png" style="width:30%; margin-right: 20px" align="left">

The *Drosophila dunni* subgroup is a species group spread across Carribbean islands, with one species per island. The species in this subgroup are recently diverged with differing levels of isolation between species. I am interested in the divergence between two species, *D. nigrodunni* and *D. arawakhana*, in which one direction of the cross produces only female offspring and reduces the lifespan of mated females. I suspect divergence in seminal fluid proteins may drive these effects to some degree and so am no investigating genome evolution and seminal fluid protein evolution across this species group.

* [Hill, Rosales-Stephens & Unckless (2020) Rapid divergence of the copulation proteins in the *Drosophila dunni group* is associated with hybrid post-mating-prezygotic incompatibilities.](files/TH_biorxivDunni_2020.05.20.pdf)